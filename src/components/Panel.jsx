...
const Panel = () => {
  ...
  useEffect(() => {
    const initializeGenerativeAI = async () => {
      ...
      const generativeModel = aiInstance.getGenerativeModel({
  ...
  function scrapeJDData(JDanswer) {
    const regex =
      /\[\s*{(?:[^{}]*"name":\s*".*?"[^{}]*"rating":\s*\d+\s*)+\}\s*(,\s*{(?:[^{}]*"name":\s*".*?"[^{}]*"rating":\s*\d+\s*)})*\s*]/s;
  ...
  return (
    <div className="mx-2 my-2">
      ...
      <div className="max-w-full mx-auto p-4 grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="flex space-x-2 mb-4 flex-wrap">
            <button
              ...
              className={`bg-blue-500 text-white p-2 rounded ${
                loading || uploadToggle ? "opacity-50 cursor-not-allowed" : ""
              }`}
            ...
            <button
              ...
              className={`bg-teal-500 text-white p-2 rounded ${
                loading || file == null || !uploadToggle
        ...
        <div className="p-4 border border-gray-300 rounded-lg">
          ...
          {answer.length ? (
            <button
              onClick={copyResult}
              className={`bg-blue-500 text-white ml-4 p-4 rounded ${
                loading || file == null || !uploadToggle
                  ? "opacity-50 cursor-not-allowed"
                  : ""
              }`}
          ...
          {answer && (
            <>
              ...
              <p className="border border-gray-300 p-2 whitespace-pre-wrap max-h-96 overflow-y-auto rounded">
                {answer}
              </p>
            </>
          )}
        ...
        <div className="p-4 border border-gray-300 rounded-lg ">
          ...
          {JDanswer.length ? (
            <button
              ...
              className={`bg-blue-500 text-white ml-4 p-2 rounded ${
                loading || file == null || !uploadToggle
                  ? "opacity-50 cursor-not-allowed"
                  : ""
              }`}
          ...
          {JDanswer && (
            <>
              ...
              <h4>Report:</h4>
              <p className="border border-gray-300 p-2 whitespace-pre-wrap max-h-44 overflow-y-auto rounded">
                {JDanswer}
              </p>
            </>
          )}
      ...
      <div className="text-center bottom-0 p-1 lg:absolute lg:left-1/2 lg:transform lg:-translate-x-1/2">
        Made with ❤️ By{" "}
        <a
          href="https://ayush-kapruwan845-portfolio.netlify.app/"
